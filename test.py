...
def perform_activity(activity, duration):
    ...
    #             if duration+last_activity_duration < 10:
    #                 cur_hedons += (2)*10+(3*star_elegible*10)
    #                 cur_health += 3*duration

    #             elif duration+last_activity_duration > 10 and duration+last_activity_duration < 180:
    ...
    #     time_since_activity = 0
        ...
        if not tired:  # not tired if not tired or using star
            if duration <= 20:
                ...
                cur_hedons += duration + \
                    (3*duration*star_elegible if duration <
                     11 else 3*10*star_elegible)
            else:
